...
export function StarButton({
  ...
  variant?: Variant
  /** Fully rounded with roomier padding (interior-page CTAs). */
  pill?: boolean
  arrow?: boolean
}) {
  return (
    <HashLink
      href={href}
      className={`group relative inline-flex items-center gap-2 border-2 ${pill ? "rounded-full px-[30px] py-[13px]" : "rounded-lg px-7 py-3"} text-sm font-semibold shadow-[0_0_0_rgba(168,85,247,0.7)] transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.6)] active:scale-[0.97] ${variantClasses[variant]}`}
    >
